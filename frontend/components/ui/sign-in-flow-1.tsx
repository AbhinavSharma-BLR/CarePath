...
> {
  ...
  componentDidCatch(error: any, errorInfo: any) {
    console.warn('CanvasRevealEffect background notice:', error)
  }

  render() {
    if (this.state.hasError) {
      return (
        <div className="absolute inset-0 bg-[#080808] bg-[radial-gradient(circle_at_center,_rgba(239,48,48,0.15)_0%,_#080808_100%)] pointer-events-none" />
      )
    }
